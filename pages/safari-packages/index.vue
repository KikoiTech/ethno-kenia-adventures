        ...
        <div class="relative bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 border-2 border-yellow-400/30">
          <div class="text-center">
            ...
            <p class="text-amber-700 mb-6">
              {{ getText({ en: "Thank you for choosing Kenya Safari Heritage. We'll contact you within 24 hours to confirm your safari adventure.", es: "Gracias por elegir Kenya Safari Heritage. Nos pondremos en contacto en 24 horas para confirmar tu aventura safari.", fr: "Merci d'avoir choisi Kenya Safari Heritage. Nous vous contacterons dans 24 heures pour confirmer votre aventure safari.", de: "Vielen Dank, dass Sie sich für Kenya Safari Heritage entschieden haben. Wir werden uns innerhalb von 24 Stunden bei Ihnen melden, um Ihr Safari-Abenteuer zu bestätigen.", zh: "感谢您选择肯尼亚野生动物园遗产。我们将在24小时内与您联系确认您的野生动物园冒险。", ja: "ケニアサファリ遺産をお選びいただきありがとうございます。24時間以内にご連絡し、サファリアドベンチャーを確認させていただきます。", sw: "Asante kwa kuchagua Urithi wa Safari Kenya. Tutakupigia ndani ya saa 24 kuthibitisha uzoefu wako wa safari." }, currentLanguage) }}
            </p>
