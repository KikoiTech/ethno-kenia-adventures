            ...
            <tr v-for="booking in filteredBookings" :key="booking.id" class="booking-row">
              <td>
                <div class="guest-info">
                  <div class="avatar">{{ booking.full_name?.charAt(0) }}</div>
                  <div class="meta">
                    <span class="name">{{ booking.full_name }}</span>
                    <span class="trip">{{ booking.tours?.title || 'Unknown Trip' }}</span>
                  </div>
                </div>
              </td>
              <td>
              ...
              <td>
                <div class="price-wrap">
                  <DollarSign class="w-3 h-3 opacity-40" />
                  <span class="font-bold">{{ booking.total_paid?.toLocaleString() }}</span>
                </div>
              </td>
              <td>
