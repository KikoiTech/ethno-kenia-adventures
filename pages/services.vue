    ...
    <section class="relative py-20 md:py-32 overflow-hidden">
      ...
      <div class="absolute inset-0 opacity-[0.08]">
        <div class="absolute inset-0" 
             style="background-image: url('data:image/svg+xml;base64,'); background-repeat: repeat; background-size: 80px 80px;">
        </div>
      </div>
      ...
      <div class="container mx-auto px-6 relative z-10">
        <div class="text-center max-w-5xl mx-auto">
          ...
          <p class="text-xl font-light text-brand-charcoal/80 max-w-4xl mx-auto leading-relaxed">
            ...
            Each journey is meticulously crafted to deliver unparalleled sophistication and authentic Kenyan hospitality.
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          <div class="group bg-brand-off-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-[1.03] border border-brand-terracotta/20">
            <div class="relative h-80 overflow-hidden">
              <img 
                ...
                alt="Luxury private jet and first-class air travel"
            ...
            <div class="p-8">
              ...
              <div class="flex items-center text-brand-terracotta font-sans text-sm font-medium">
                <span>Discover Elite Service</span>
          ...
          <div class="group bg-brand-off-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-[1.03] border border-brand-terracotta/20">
            ...
            <div class="p-8">
              <h3 class="text-2xl font-serif text-brand-charcoal mb-4">Bespoke Safari Experiences</h3>
              <p class="text-brand-charcoal/80 font-sans leading-relaxed mb-4">
                Tailor-made luxury safaris designed exclusively for you. 
          ...
          <div class="group bg-brand-off-white rounded-3xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-700 hover:scale-[1.03] border border-brand-terracotta/20">
            ...
            <div class="p-8">
              <h3 class="text-2xl font-serif text-brand-charcoal mb-4">Corporate Excellence</h3>
              <p class="text-brand-charcoal/80 font-sans leading-relaxed mb-4">
                Exclusive corporate retreats in Kenya's most spectacular locations. 
      ...
      <div class="container mx-auto px-6">
        <div class="text-center max-w-5xl mx-auto">
          ...
          <div class="flex flex-col sm:flex-row gap-8 justify-center items-center">
            <a 
              href="/contact-us"
              class="inline-flex items-center justify-center px-12 py-5 bg-brand-off-white text-brand-charcoal font-sans font-medium rounded-full transition-all duration-500 hover:scale-105 hover:shadow-2xl border-2 border-brand-off-white"
            >
              <span>Request Exclusive Experience</span>
