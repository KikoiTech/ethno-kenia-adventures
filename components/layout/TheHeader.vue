<template>
  <header class="fixed top-0 left-0 w-full z-50 shadow-md">
    ...
    <div class="bg-brand-charcoal py-2 px-6 hidden sm:block">
      <div class="container mx-auto flex justify-between items-center text-brand-off-white text-xs md:text-sm font-sans">
        ...
        <div class="flex items-center space-x-6">
          ...
          <a href="tel:+254700000000" class="flex items-center hover:text-brand-terracotta transition-colors duration-300">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-center space-x-4">
          <a href="#" class="hover:text-brand-terracotta transition-colors duration-300">
    ...
    <nav class="bg-brand-off-white w-full px-6 py-2 flex justify-between items-center text-brand-charcoal transition-all duration-300">
      <!-- Logo -->
      <div class="flex-shrink-0">
        <NuxtLink to="/">
          <!-- The src starts with / because it is in the public folder -->
          <img 
            src="/logo.png" 
      ...
      <div class="md:hidden">
        <button @click="isMenuOpen = !isMenuOpen" class="focus:outline-none">
           <!-- CORRECTED SVG ICON -->
          <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg>
        </button>
      </div>
